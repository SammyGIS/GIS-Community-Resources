...
```mermaid
graph TD
    A[Viz: Folium, Pydeck, Kepler.gl] --> B[Analysis: Spatial Clustering, Kernels]
    B --> C[Modeling: Geographically Weighted Regression]
    C --> D[Open Science: Notebooks & Reproducibility]
```
